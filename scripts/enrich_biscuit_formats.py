...
BISCUIT_FORMATS = {
    ...
    'madeleine':            {'nombre': '18-20 madeleines'},
    'madeleine-cacao':      {'nombre': '18-20 madeleines'},
    'madeleine-praline':    {'nombre': '18-20 madeleines'},
    ...
    'joconde':              {'tapis-cm': '40 × 30'},
    'joconde-cacao':        {'tapis-cm': '40 × 30'},
